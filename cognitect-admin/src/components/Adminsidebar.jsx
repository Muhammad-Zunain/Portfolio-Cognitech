    ...
    <div className="flex items-center justify-between">
      <div className="flex items-center justify-start rtl:justify-end">
        ...
        <Link to="dashboard" className="flex ms-2 md:me-24">
          <img src={Logo} className="h-16" alt="Cognitech Logo" />
          ...
          <div className="flex items-center ms-3">
            <div>
              <button type="button" className="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdown-user">
                ...
                {/* <img className="w-8 h-8 rounded-full" sr c="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="user photo"> */}
              </button>
            </div>
...
<aside id="logo-sidebar" className="mt-20 fixed top-0 left-0 w-72 h-screen pt-10 transition-transform -translate-x-full bg-admindashbord  sm:translate-x-0" aria-label="Sidebar">
   <div className="h-full px-3 pb-4 overflow-y-auto bg-admindashbord ">
      <ul className="space-y-2 font-medium">
         <li>
            <Link to="dashboard" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-fuchsia-600 group">
         ...
         <li>
            <Link to="category" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-fuchsia-600 group">
         ...
         <li>
            <button type="button" className="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-fuchsia-600" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                  ...
                  <Link to="project" className="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Projects</Link>
            ...
            <ul id="dropdown-example" className="hidden py-2 space-y-2">
                  <li>
                     <Link to="#" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-fuchsia-600">Front End Projects</Link>
                  </li>
                  <li>
                     <Link to="#" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-fuchsia-600">Back End Projects</Link>
                  </li>
                  <li>
                     <Link to="#" className="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-fuchsia-600">Full Stack Projects</Link>
                  </li>
            </ul>
         </li>
         
         <li>
            <Link to="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-fuchsia-600 group">
               ...
               <span className="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-white 
               bg-[#1E143B] rounded-full dark:bg-[#1E143B] dark:text-white">3</span>
            </Link>
         </li>
         <li>
            <Link to="addproject" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-fuchsia-600 group">
