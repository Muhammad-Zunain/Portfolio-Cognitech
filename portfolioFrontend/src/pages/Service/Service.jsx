        ...
        <div className="service-wrapper">
          <div class="about-service-wrapper">
            <div className="about-service-inner-wrapper">
              ...
              <p>
                We are dedicated to delivering exceptional solutions tailored to
                your unique business needs. From front-end design to back-end
                development, our team combines innovation and expertise to
                ensure seamless functionality, outstanding user experiences, and
                impactful results across all digital platforms. Let us help you
                transform your ideas into reality with excellence at every step.
              </p>
